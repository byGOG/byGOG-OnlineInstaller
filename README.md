# by GOG - Online Installer

![Screenshot](https://docs.google.com/uc?export=download&id=1EG_k9Snb34U1VfrL0hZwUZ-8pBrQnBcn)

##### `curl -sL#o "%TEMP%\byGOG-OnlineInstaller.cmd" "https://github.com/byGOG/byGOG-OnlineInstaller/releases/download/setup/byGOG-OnlineInstaller.cmd" && CALL %TEMP%\byGOG-OnlineInstaller.cmd`
