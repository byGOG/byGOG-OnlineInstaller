...
IF "%PROCESSOR_ARCHITECTURE%"=="AMD64" (
    SET "URL=https://github.com/c0re100/qBittorrent-Enhanced-Edition/releases/download/release-%VERSION%/qbittorrent_enhanced_%VERSION%_qt6_x64_setup.exe"
) ELSE (
    SET "URL=https://github.com/c0re100/qBittorrent-Enhanced-Edition/releases/download/release-%VERSION%/qbittorrent_enhanced_%VERSION%_setup.exe"
)
