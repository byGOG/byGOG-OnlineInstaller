...
POWERSHELL; Start-Process cmd -ArgumentList '/c mklink %PUBLIC%\Desktop\GoodbyeDPI %GoodbyeDpiDir%\2_any_country_dnsredir.cmd' -WindowStyle Hidden -Verb RunAs -Wait
